...
<div class="tabs">
    <button class="tab-btn <?= $tab==='summary'?'active':'' ?>" onclick="switchTab('summary')">📊 Ringkasan Stok</button>
    <button class="tab-btn <?= $tab==='in'?'active':'' ?>" onclick="switchTab('in')">📥 Stok Masuk</button>
    <button class="tab-btn <?= $tab==='out'?'active':'' ?>" onclick="switchTab('out')">📤 Stok Keluar</button>
    <button class="tab-btn <?= $tab==='history'?'active':'' ?>" onclick="switchTab('history')">📋 Riwayat</button>
</div>
